...
* [Documentation for Wiki.js 1.x](README.md)

## Installation

* [Prerequisites](install/prerequisites.md)
* [Installation](install/installation/README.md)
  * [Authentication](install/installation/authentication.md)
  * [Configuration File](install/installation/configuration-file.md)
  * [Database](install/installation/database.md)
  * [Git](install/installation/git.md)
...
* [Manage Access Rights](administration/manage-access-rights.md)
* [Setup NGINX Reverse Proxy](administration/setup-nginx-reverse-proxy.md)
